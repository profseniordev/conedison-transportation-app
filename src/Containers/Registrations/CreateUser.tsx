          ...
          <div className="box-item-body">
                ...
                <RolesAsyncSearch
                  onSelect={(item: any) =>
                    this.handleValueChange(
                      'roles',
                      item ? item.map((role) => role.value.id) : []
                    )
                  }
                  isMulti
            ...
            <div className="row role-contract">
              <div className="form-group col-sm-4">
                ...
                <SubcontractorAsyncSearch
                  isClearable={false}
                  onSelect={(item) =>
                    this.handleValueChange('subcontractorId', item.value.id)
                  }
                />
            ...
            <div className="row role-upload">
              ...
              <div className="form-group ml-3  upload-control">
                <div
                  className="btn ce-btn-confirm cursor-pointer ce-mr-10"
                ...
                {this.showImage && (
                  <div className="photo-detail">
                    <div
                      className="user-photo-preview ce-mr-10"
                      style={{
                    ...
                    <div>
                      <div>
                        <span className="photo-name">{this.file.name}</span>
                      </div>
