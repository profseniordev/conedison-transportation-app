...
export class ApointJobAddSliderComponent extends React.Component<Props> {
        ...
        return (
          <div className={'worker-row-item'}>
            <div className="ce-assign-worker side-apoint-job">
              ...
              >
                <span>
                  <img src={mapLocationImage} className="avatar" alt="" />
              ...
              <div
                className="ce-assign-worker-record work-location-list d-flex"
                style={{ flexDirection: 'column' }}
              >
                {Array.isArray(worker.timesheets)
                  ? worker.timesheets.map((timesheet) => {
                      return (
