      ...
      <ul className="nav d-flex justify-content-between">
        ...
        <div className="nav-action-mobile">
          <div className="d-flex align-items-center">
            {/*<a className="nav-link" href="#"><img src={cloneSolid} alt=""></img> Duplicate</a>*/}
            <a className="nav-link" href={`/job/${jobStore.jobDetail.id}/edit`}>
              <i className="fa fa-pencil mr-1"/>Edit Job
            </a>
            <a
              className="nav-link"
              href="#"
            ...
            >
              <i className="fa fa-times mr-1"/>Cancel Job
            </a>
          </div>
        </div>
      </ul>
          ...
          <div className="box-item-body">
            <div className="job-item d-flex justify-content-between align-items-center">
              ...
              <div className="w-20">
                ...
                <div>{jobStore.jobDetail.poet}</div>
              </div>
            </div>
  ...
  renderContent(tab) {
    switch (tab) {
      ...
      case TabContent.TabHistory:
        return (
          <History
           changesLog={jobStore.jobDetail.changesLog}
           canDownload={true}
        ...
        <div>
          ...
          <div className="text-center">
            ...
            <div className="d-flex justify-content-between mx-2 mt-40 mb-25">
              ...
              <span className="btn ce-btn-modal-save" onClick={this.cancelJob}>
