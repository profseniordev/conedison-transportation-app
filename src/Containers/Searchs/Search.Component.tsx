      ...
      <div className="left-item">
        <div className="left-item-body d-flex">
          <div className="form-control-search mr-2 w-100">
            <img src={search} alt="" />
            <input className="ce-form-control " placeholder="Search" />
          </div>
          ...
          <div className="btn-group">
            {this.props.hasFilter && (
              <button
                ...
                className={
                  'btn border d-flex align-items-center ' + this.filteractive
                }
                type="button"
              >
                {this.filteractive == '' ? (
            ...
            {this.props.hasSort && (
              <button
                ...
                className={
                  'btn border d-flex align-items-center ' + this.sortactive
                }
                type="button"
              >
                {this.sortactive == '' ? (
