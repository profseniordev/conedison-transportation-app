...
import { userService, actions } from '../../Services';
...
class Workers extends React.Component<any> {
  ...
  changeStatus = (id, status) => {
    this.props.updateWorkerStatus(id, { status: status.toLowerCase() });
        ...
        workers = workers.filter((item) => {
          if (key === 'workerTypes') {
            ...
            return (
              ...
              item[key]
                .toLowerCase()
                .indexOf(searchParams[key].toLowerCase()) >= 0
            );
          }
        });
      }
  ...
  render() {
    const { isImport, workers_filtered } = this.state;
        ...
        <div className="scroll-mobile">
          <div className="div-table table-responsive">
            ...
            <div className="div-body">
              <div className="div-scroll max-height-bigger">
                {workers_filtered &&
                  workers_filtered.map((item, index) => {
